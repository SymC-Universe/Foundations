...
EXPECTED_SELECTION_SHA = "f0f266117f5f86ee6cf9e86667a73f4412844c2555a4fa0c81250f40978d80dc"
...
OUT = RESULTS / "dephasing_d_blind_reveal_v01.json"
...
def main(selection_path):
    ...
    if recon_failures:
        ...
        status = "FAIL_H11D_BLIND_REVEAL"
    else:
        status = "PASS_H11D_BLIND_REVEAL"

    result = {
        "schema": "stability-arc-dephasing-d-blind-reveal-v0.1",
        "status": status,
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        raise SystemExit("usage: dephasing_d_blind_reveal_v01.py <stageA_selection.json>")
    main(sys.argv[1])
